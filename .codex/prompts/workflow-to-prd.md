# /workflow-to-prd Slash Prompt

Move agreed workflow context into PRD synthesis.
...
2. Read `skills/workflow-to-prd/SKILL.md` completely before acting.
...
- `skills/workflow-to-prd/SKILL.md`
