# /workflow-intake Slash Prompt

Create or lock workflow intake before conversation continues.
...
2. Read `skills/workflow-intake/SKILL.md` completely before acting.
