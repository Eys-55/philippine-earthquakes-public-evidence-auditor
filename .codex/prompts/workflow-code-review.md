# /workflow-code-review Slash Prompt

Review workflow implementation against spec and standards.
...
2. Read `skills/workflow-code-review/SKILL.md` completely before acting.
